...
var year_list = ['2013','2014','2015','2016','2017','2018','2019']
var month_list = ['year_median','1half','2half'];

var aoi_list = ['Y.S.R.','Ajmer','Alwar']
...
var training = ee.FeatureCollection('users/mtpictd/L7balancedtrainingdata')
...
var aoi_name = aoi_list[i];
  for (var j in year_list)
  {
    ...
    var aoi = aoi_list[j];
    var aoi = ee.FeatureCollection('users/mtpictd/india_district_boundaires')
    ...
    str = str.split('.').join(''); //remove '.' from name: For ex: Y.S.R. district
    var misc = '_'+month 
